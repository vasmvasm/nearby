...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  google.maps.event.addListener(this.map_, 'idle', function() {
	that.tempmarkers_ = that.markers_  
    that.redraw();
  });
...
MarkerClusterer.prototype.createClusters_ = function() {
  ...
  //console.log(this.markers_.length+"-------->"+this.markers_[this.markers_.length-1].getPosition().lat());
  for (var i = 0, marker; marker = this.tempmarkers_[i]; i++) {
